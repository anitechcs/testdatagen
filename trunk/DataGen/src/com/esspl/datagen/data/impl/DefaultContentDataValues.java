package com.esspl.datagen.data.impl;

import com.esspl.datagen.data.ContentDataValues;
...
public class DefaultContentDataValues implements ContentDataValues {
	...
	private static String[] companyNames = { "Google", "Yahoo",
			"Infosys", "Tcs", "Mind Fire", "Mind Tree",
			"iFlex", "Cisco", "CMC", "HCL",
			"Maruti", "Hyundai", "Ford", "Toyota",

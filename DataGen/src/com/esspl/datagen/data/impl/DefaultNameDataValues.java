...
import com.esspl.datagen.data.NameDataValues;
...
public class DefaultNameDataValues implements NameDataValues {
	...
	private static String[] statuses = { "Single", "Married", "Separated", "Divorced", "Widowed", "Cohabiting", "Unmarried partners"};
	private static String[] prefixes = { "Mr", "Mrs", "Ms", "Sri", "Dr", "Lady", "Lord"};
	private static String[] firstNames = { "Aaron", "Abby", "Abigail", "Adam",
			...
			"Willie", "Wyatt", "Zachary", "Tapas", "Sudhir", "Santosh", "Sailendu",
			"Suvendu", "Harekrushna", "Venugopal", "Satyajit", "Subrat", "Chandrika",
			"Nirmal", "Abhisek", "Debasish", "Jeevan", "Ankur", "Asim", "Satya", "Sandeep", 
			"Antaryami", "Biswashree", "Prem", "Dhruti", "Pankaj", "Priyabrata", "Pranaya",
			"Bijay", "Jyoti", "Subhasmita", "Anshuman", "Abani", "Alok", "Amrit", "Rekha", "Madhu",
			"Soumya", "Saswati", "Subhakanta", "Sambit"};
